...
/home/masky/distribution/build.JELOS-RK3566.aarch64/toolchain/bin/aarch64-libreelec-linux-gnueabi-g++ -std=c++11  -fPIC -O3 -fno-strict-aliasing -march=armv8-a+crc -mtune=cortex-a53 -lSDL2 -lpthread  gkdminiplus.cpp cJSON.c -o sdl_interface
