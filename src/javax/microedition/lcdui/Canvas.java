...
public abstract class Canvas extends Displayable
{
	...
	public int getGameAction(int keyCode)
	{
		switch(keyCode)
		{
			...
			case Mobile.KEY_NUM7: return GAME_A;
			case Mobile.KEY_NUM9: return GAME_B;
			case Mobile.KEY_STAR: return GAME_C;
			case Mobile.KEY_POUND: return GAME_D;
	...
	public int getKeyCode(int gameAction)
	{
		switch(gameAction)
		{
			...
			case Mobile.GAME_A: return Mobile.KEY_NUM7;
			case Mobile.GAME_B: return Mobile.KEY_NUM9;
			case Mobile.GAME_C: return Mobile.KEY_STAR;
			case Mobile.GAME_D: return Mobile.KEY_POUND;
		}
